...
model1 = architecture.base(num_classes, **architecture.kwargs)
model1.cuda()
checkpoint1 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/vgg_cifar10/checkpoint-50.pt')
model1.load_state_dict(checkpoint1['model_state'])

model2 = architecture.base(num_classes, **architecture.kwargs)
model2.cuda()
checkpoint2 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/vgg_cifar10/checkpoint-100.pt')
model2.load_state_dict(checkpoint2['model_state'])

model3 = architecture.base(num_classes, **architecture.kwargs)
model3.cuda()
checkpoint3 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/vgg_cifar10/checkpoint-200.pt')
