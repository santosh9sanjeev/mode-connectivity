...
bend_coordinates = np.array([[ 0.0000000e+00  ,0.0000000e+00], [ 3.1151825e+02,  6.2418598e-01], [ 3.1151846e+02,  3.3248842e-02], [ 3.1151810e+02,  6.0494155e-01], [ 3.1150452e+02, -3.7059933e-01]])
print(bend_coordinates)
...
plt.scatter(bend_coordinates[2, 0], bend_coordinates[2, 1], marker='v', c='k', s=120, zorder=2)
plt.scatter(bend_coordinates[3, 0], bend_coordinates[3, 1], marker='^', c='k', s=120, zorder=2)
plt.scatter(bend_coordinates[4, 0], bend_coordinates[4, 1], marker='D', c='k', s=120, zorder=2)
