...
parser.add_argument('--margin_left', type=float, default=2, metavar='M',
                    help='left margin (default: 0.2)')
parser.add_argument('--margin_right', type=float, default=10, metavar='M',
                    help='right margin (default: 0.2)')
parser.add_argument('--margin_bottom', type=float, default=2, metavar='M',
                    help='bottom margin (default: 0.)')
parser.add_argument('--margin_top', type=float, default=2, metavar='M',
...
checkpoint1 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/models_model_soups/rsna_cnn_v1/model_13.pth')
...
checkpoint2 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/models_model_soups/rsna_cnn_v1/model_4.pth')
...
model3 =  getattr(models, 'resnet18')(pretrained=True)
...
checkpoint3 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/models_model_soups/rsna_cnn_v1/model_19.pth')
...
base_model =  getattr(models, 'resnet18')(pretrained=True)
