...
checkpoint2 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/models_model_soups/cifar10_model_soups_models/checkpoint_10.2.pt')
checkpoint3 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/models_model_soups/cifar10_model_soups_models/checkpoint_10.3.pt')
checkpoint4 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/models_model_soups/cifar10_model_soups_models/checkpoint_10.4.pt')
checkpoint5 = torch.load('/home/santoshsanjeev/dnn-mode-connectivity/models_model_soups/cifar10_model_soups_models/checkpoint_10.5.pt')
# uniform_soup = torch.load('')
# greedy_soup = torch.load('')
...
num_classes = checkpoint1['classification_head.weight'].shape[0]
normalize = True
model5 = train_utils.ModelWrapper(model, feature_dim, num_classes, normalize)
model5.load_state_dict(checkpoint5)
model5 = model5.to('cuda')
test_res = utils.test(loaders['test'], model5, criterion, regularizer)
print('55555555',test_res['accuracy'])


w = list()
#curve_parameters = []#list(curve_model.net.parameters())
curve_parameters = [model1.parameters(),model2.parameters(), model3.parameters(), model4.parameters(), model5.parameters()]#list(curve_model.net.parameters())

for i in range(len(curve_parameters)):
    print(i)
